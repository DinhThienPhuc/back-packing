  ...
  (function (a, b) {
    ...
    a.widget("ui.rangeSlider", {
      options: {
        ...
        defaultValues: { min: 200, max: 4000 },
        wheelMode: null,
        wheelSpeed: 4,
        arrows: !0,
        valueLabels: "show",
      ...
      _setFormatterOption: function (a, b) {
        "formatter" === a &&
          ...
          (this.options.formatter = this._rightLabel(
            "option",
            "formatter",
            b,
          )));
      ...
      values: function (a, b) {
        ...
        if ("undefined" != typeof a && "undefined" != typeof b) {
          if (!this._initialized)
            return (this._values.min = a), (this._values.max = b), this._values;
        ...
        var d,
          ...
          f =
            null === this.cache.parent.offset
              ...
              : this.cache.parent.offset.left;
        return (
          this.options.symmetricPositionning
            ? ((a -= this.options.isLeft ? 0 : this.cache.width.outer),
              (d = this.cache.parent.width - 2 * this.cache.width.outer))
            : ((a += this.options.isLeft ? 0 : this.cache.width.outer),
              (d = this.cache.parent.width)),
          0 === d ? this._value : ((e = (a - f) / d), e * (c - b) + b)
        );
      },
      value: function (a) {
        return (
    ...
    a.widget("ui.rangeSliderBar", a.ui.rangeSliderDraggable, {
      ...
      _setLeftRange: function () {
        ...
        var a = this._values.max,
          b = { min: !1, max: !1 };
        "undefined" != typeof this.options.range.min &&
        this.options.range.min !== !1
          ? (b.max = this._leftHandle("substract", a, this.options.range.min))
          : (b.max = !1),
          "undefined" != typeof this.options.range.max &&
          this.options.range.max !== !1
            ? (b.min = this._leftHandle("substract", a, this.options.range.max))
            : (b.min = !1),
      ...
      _setRightRange: function () {
        ...
        "undefined" != typeof this.options.range.min &&
        this.options.range.min !== !1
          ? (b.min = this._rightHandle("add", a, this.options.range.min))
          : (b.min = !1),
          "undefined" != typeof this.options.range.max &&
          this.options.range.max !== !1
            ? (b.max = this._rightHandle("add", a, this.options.range.max))
            : (b.max = !1),
      ...
      _onDragLeftHandle: function (a, b) {
        if (
          (this._cacheIfNecessary(),
          b.element[0] === this.options.leftHandle[0])
        ) {
          if (this._switchedValues())
            return this._switchHandles(), void this._onDragRightHandle(a, b);
      ...
      _onDragRightHandle: function (a, b) {
        if (
          (this._cacheIfNecessary(),
          b.element[0] === this.options.rightHandle[0])
        ) {
          if (this._switchedValues())
            return this._switchHandles(), void this._onDragLeftHandle(a, b);
      ...
      (this.label1 = b),
        ...
        (this.ConstraintPositions = function (a, b) {
          ((a.center < b.center && a.outerRight > b.outerLeft) ||
            (a.center > b.center && b.outerRight > a.outerLeft)) &&
    ...
    a.widget("ui.rangeSliderLabel", a.ui.rangeSliderMouseTouch, {
      ...
      _setFormatterOption: function (a, b) {
        "formatter" === a &&
          ...
          ((this.options.formatter = b), this._display(this._value));
      },
      ...
      pair: function (a) {
        null === this._positionner &&
          ((this._positionner = new c(this.element, a, this.widgetName, {
            show: this.options.show,
            durationIn: this.options.durationIn,
            durationOut: this.options.durationOut,
            delayOut: this.options.delayOut,
