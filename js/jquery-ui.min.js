      ...
      (o = function () {
        ...
        (t.fn.position = function (n) {
          ...
          return (
            ...
            "right" === n.at[0]
              ? (v.left += g)
              : "center" === n.at[0] && (v.left += g / 2),
            "bottom" === n.at[1]
              ? (v.top += m)
              : "center" === n.at[1] && (v.top += m / 2),
            (p = e(C.at, g, m)),
            (v.left += p[0]),
            (v.top += p[1]),
            this.each(function () {
              ...
              "right" === n.my[0]
                ? (I.left -= u)
                : "center" === n.my[0] && (I.left -= u / 2),
                "bottom" === n.my[1]
                  ? (I.top -= d)
                  : "center" === n.my[1] && (I.top -= d / 2),
                (I.left += M[0]),
                (I.top += M[1]),
                o() || ((I.left = h(I.left)), (I.top = h(I.top))),
                (s = { marginLeft: f, marginTop: b }),
                t.each(["left", "top"], function (e, i) {
                  t.ui.position[x[e]] &&
                    t.ui.position[x[e]][i](I, {
                      targetWidth: g,
                      targetHeight: m,
                      elemWidth: u,
                      elemHeight: d,
    ...
    t.widget("ui.checkboxradio", [
      t.ui.formResetMixin,
      {
        ...
        _updateLabel: function () {
          this.label
            .contents()
            .not(this.element.add(this.icon).add(this.iconSpace))
            .remove(),
