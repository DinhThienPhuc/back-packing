            ...
            a(this).append(
              ...
              a("a", this).each(function (b) {
                var f = a("img", this).attr("src"),
                  g = a(this).attr("href"),
                  h = "";
                ((0 === b && !e) || a(this).hasClass("sp-default")) &&
                  ((h = ' class="sp-current"'),
                  (c = g),
                  (d = a("img", this)[0].src)),
                  a(this)
            ...
            a(this)
              ...
              .fadeIn(250, function () {
                ...
                a(this)
                  .parents(".sp-wrap")
                  .find(".sp-large")
                  .animate({ height: b }, "fast", function () {
        ...
        a(document.body).on("click", "#sp-next", function (b) {
          ...
          if (d >= e);
            ...
            d == e - 1 && a("#sp-next").css("opacity", ".1"),
              ...
              a(".sp-selected .sp-thumbs a:eq(" + d + ")").addClass(
                "sp-current",
              ),
              a(".sp-selected .sp-large")
                .empty()
                .append("<a href=" + g + '><img src="' + h + '"/></a>'),
        ...
        a(document.body).on("click", "#sp-prev", function (b) {
          ...
          if (0 >= d);
            ...
            a("#sp-next").css("opacity", "1"),
              a(".sp-selected .sp-current").removeClass(),
              a(".sp-selected .sp-thumbs a:eq(" + e + ")").addClass(
                "sp-current",
              ),
              a(".sp-selected .sp-large")
                .empty()
                .append("<a href=" + f + '><img src="' + g + '"/></a>'),
              a(".sp-lightbox img").fadeOut(250, function () {
                a(this).remove(),
                  a(".sp-lightbox")
                    .data("currenteq", d)
